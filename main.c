...
int main(void)
{
	...
	len = _printf("LPI %d et %i", 8566644, 8566644);
	len2 = printf("LPI %d et %i", 8566644, 8566644);
	...
	len = _printf("SPI %d et %i", 5, 5);
	len2 = printf("SPI %d et %i", 5, 5);
	...
	len = _printf("Z %d et %i", 0, 0);
	len2 = printf("Z %d et %i", 0, 0);
	printf("Zero (_printf):[%d, %i]\n", len, len);
	_printf("Zero (_printf):[%d, %i]\n", len, len);
	printf("Zero (printf):[%d, %i]\n", len2, len2);
	_printf("Zero (printf):[%d, %i]\n", len2, len2);

	len = _printf("LNI %d et %i", -681, -681);
	len2 = printf("LNI %d et %i", -681, -681);
	...
	len = _printf("SNI %d et %i", -4, -4);
	len2 = printf("SNI %d et %i", -4, -4);
